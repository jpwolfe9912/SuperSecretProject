...
#define FCLK_SLOW()                                                                              \
    {                                                                                            \
        MODIFY_REG(SPI1->CR1, LL_SPI_BAUDRATEPRESCALER_DIV256, LL_SPI_BAUDRATEPRESCALER_DIV128); \
    } /* Set SCLK = slow, approx 280 KBits/s*/
#define FCLK_FAST()                                                                             \
    {                                                                                           \
        MODIFY_REG(SPI1->CR1, LL_SPI_BAUDRATEPRESCALER_DIV256, LL_SPI_BAUDRATEPRESCALER_DIV16); \
