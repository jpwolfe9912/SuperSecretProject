...
// */
// Adafruit_ImageReader(FatVolume &fs) { filesys = &fs; }
...
// */
// ImageReturnCode drawBMP(const char *filename,
...
//              completion, other values on failure).
// */
// ImageReturnCode loadBMP(const char *filename,
//                                               Adafruit_Image &img)
// {
...
//              completion, other values on failure).
// */
// ImageReturnCode bmpDimensions(const char *filename,
//                                                     int32_t *width,
//                                                     int32_t *height)
// {
...
//     @return  None (void).
// */
// void printStatus(ImageReturnCode stat, Stream &stream)
// {
...
//         printf("Not a supported BMP variant.");
//     else if (stat == IMAGE_ERR_MALLOC)
//         printf("Malloc failed (insufficient RAM).");
// }